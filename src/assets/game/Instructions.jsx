    ...
    <>
      <div className="page-container instructions">
        ...
        <p className='parrafo-instructions'>Una vez que el jugador ha hecho todos los ataques que quiera, puede terminar su turno, teniendo la opción de
          ...
          tiene 3 ejércitos, puede mover 1 o 2 ejércitos a otro territorio vecino. Finalmente, si durante su turno el
          jugador logró conquistar alguna comuna, recibirá una DCCarta, la que podrá usar en su siguiente turno, si lo
          estima conveniente. Estas cartas traen distintos beneficios, pero también pueden traer maldiciones, las que
          perjudicarán al jugador que le salgan.
        </p>
        <h3>Fin del juego</h3>
